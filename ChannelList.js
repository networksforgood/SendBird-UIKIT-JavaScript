import {
  a as _objectSpread2,
  e as _toConsumableArray,
  c as LocalizationContext,
  w as withSendbirdContext,
  b as _slicedToArray,
  u as uuidv4,
} from "./LocalizationContext-ec52e278.js";
...
import {
  ...
  b as MenuItems,
  c as MenuItem,
  i as CREATE_CHANNEL$1,
  j as UPDATE_USER_MESSAGE,
  L as LEAVE_CHANNEL,
  S as SEND_MESSAGE_START,
  h as UserProfileProvider,
} from "./index-e9eccbb4.js";
import {
  f as filterChannelListParams,
  g as getChannelsWithUpsertedChannel,
  t as truncate,
} from "./utils-818b10da.js";
import { C as ChannelAvatar } from "./index-3e543129.js";
import {
  B as Badge,
  i as isBroadcastChannelEnabled,
  a as isSuperGroupChannelEnabled,
  I as InviteMembers,
  c as createDefaultUserListQuery,
  b as createChannel,
  L as LeaveChannel,
} from "./LeaveChannel-9cf98d2b.js";
import {
  g as format,
  h as LabelStringSet,
  I as Icon,
  ...
  d as IconColors,
  L as Label,
  a as LabelTypography,
  b as LabelColors,
  A as Avatar,
  P as PlaceHolder,
  f as PlaceHolderTypes,
} from "./index-4456ba1e.js";
...
function AddChannel(_ref) {
  ...
  return /*#__PURE__*/ React__default.createElement(
    ...
    showModal &&
      step === 1 &&
      /*#__PURE__*/ React__default.createElement(InviteMembers, {
        swapParams:
...
function ChannelPreviewAction(_ref) {
  ...
  return /*#__PURE__*/ React__default.createElement(
    ...
    showModal &&
      /*#__PURE__*/ React__default.createElement(LeaveChannel, {
...
var pubSubHandler = function pubSubHandler(pubSub, channelListDispatcher) {
  ...
  subScriber.set(
    CREATE_CHANNEL$1,
    pubSub.subscribe(CREATE_CHANNEL$1, function (msg) {
...
function ChannelList(props) {
  ...
  return /*#__PURE__*/ React__default.createElement(
    ...
    showProfileEdit &&
      /*#__PURE__*/ React__default.createElement(ConnectedEditUserProfile, {
    ...
    /*#__PURE__*/ React__default.createElement(
      ...
      sdkError &&
        /*#__PURE__*/ React__default.createElement(ChannelsPlaceholder, {
          ...
          sortedChannels.map(function (channel, idx) {
            ...
            return renderChannelPreview
              ...
              : /*#__PURE__*/ React__default.createElement(ChannelPreview, {
                  ...
                  ChannelAction: /*#__PURE__*/ React__default.createElement(
