  ...
  switch (action.type) {
    ...
    case FETCH_CHANNELS_SUCCESS: {
      ...
      return LocalizationContext._objectSpread2(
        ...
        {
          allChannels: [].concat(
            LocalizationContext._toConsumableArray(state.allChannels),
            LocalizationContext._toConsumableArray(filteredChannels)
          ),
        }
      );
    }
    ...
    case CREATE_CHANNEL: {
      ...
      if (state.channelListQuery) {
        if (
          ...
          return LocalizationContext._objectSpread2(
            LocalizationContext._objectSpread2({}, state),
            utils.getChannelsWithUpsertedChannel(state.allChannels, channel)
          );
        }
      ...
      return LocalizationContext._objectSpread2(
        ...
        {},
        {
          ...
          allChannels: [channel].concat(
            LocalizationContext._toConsumableArray(
      ...
      if (state.channelListQuery) {
        if (
          ...
          return LocalizationContext._objectSpread2(
            ...
            {},
            {
              allChannels: utils.getChannelsWithUpsertedChannel(
                state.allChannels,
                _channel
              ),
            }
    ...
    case ON_USER_LEFT: {
      ...
      if (state.channelListQuery) {
        if (
          ...
          var _filteredChannels2 = utils.getChannelsWithUpsertedChannel(
            state.allChannels,
            _channel2
          );
...
ChannelPreview.propTypes = {
  channel: PropTypes__default["default"].shape({
    members: PropTypes__default["default"].arrayOf(
...
ChannelHeader.propTypes = {
  ...
  iconButton: PropTypes__default["default"].oneOfType([
    PropTypes__default["default"].element,
    PropTypes__default["default"].instanceOf(index$3.IconButton),
  ]),
...
function EditUserProfile(_a) {
  ...
  var stringSet = React.useContext(LocalizationContext.LocalizationContext)
    .stringSet;
...
var ConnectedEditUserProfile = LocalizationContext.withSendbirdContext(
  EditUserProfile,
  mapStoreToProps
);
...
var pubSubHandler = function pubSubHandler(pubSub, channelListDispatcher) {
  ...
  subScriber.set(
    index$3.CREATE_CHANNEL,
    pubSub.subscribe(index$3.CREATE_CHANNEL, function(msg) {
  ...
  subScriber.set(
    index$3.UPDATE_USER_MESSAGE,
    pubSub.subscribe(index$3.UPDATE_USER_MESSAGE, function(msg) {
      var channel = msg.channel,
        message = msg.message;
  ...
  subScriber.set(
    index$3.LEAVE_CHANNEL,
    pubSub.subscribe(index$3.LEAVE_CHANNEL, function(msg) {
      var channel = msg.channel;
      channelListDispatcher({
  ...
  subScriber.set(
    index$3.SEND_MESSAGE_START,
    pubSub.subscribe(index$3.SEND_MESSAGE_START, function(msg) {
      var channel = msg.channel;
      channelListDispatcher({
  ...
  return /*#__PURE__*/ React__default["default"].createElement(
    ...
    /*#__PURE__*/ React__default["default"].createElement(
      ...
      /*#__PURE__*/ React__default["default"].createElement(ChannelHeader, {
        ...
        iconButton: /*#__PURE__*/ React__default["default"].createElement(
          AddChannel,
          {
            disabled: !isOnline,
      ...
      /*#__PURE__*/ React__default["default"].createElement(
        ConnectedEditUserProfile,
        {
          ...
          onSubmit: function onSubmit(newName, newFile) {
            sdk.updateCurrentUserInfoWithProfileImage(
              newName,
              newFile,
            ...
            return renderChannelPreview
              ...
              : /*#__PURE__*/ React__default["default"].createElement(
                  ChannelPreview,
                  {
                    ...
                    ChannelAction: /*#__PURE__*/ React__default[
                      "default"
                    ].createElement(ChannelPreviewAction, {
                      disabled: !isOnline,
...
ChannelList.propTypes = {
  ...
  queries: PropTypes__default["default"].shape({
    channelListQuery: PropTypes__default["default"].shape({
      ...
      channelUrlsFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
      customTypesFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
      ...
      userIdsExactFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
      userIdsIncludeFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
    ...
    applicationUserListQuery: PropTypes__default["default"].shape({
      limit: PropTypes__default["default"].number,
      userIdsFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
      metaDataKeyFilter: PropTypes__default["default"].string,
      metaDataValuesFilter: PropTypes__default["default"].arrayOf(
        PropTypes__default["default"].string
      ),
    }),
  }),
  onBeforeCreateChannel: PropTypes__default["default"].func,
  renderChannelPreview: PropTypes__default["default"].oneOfType([
    PropTypes__default["default"].element,
  ...
  renderHeader: PropTypes__default["default"].oneOfType([
    PropTypes__default["default"].element,
    PropTypes__default["default"].func,
  ]),
